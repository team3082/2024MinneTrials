...
public class Vector2 {
   ...
   *
   * @param vectorToAdd A Vector2 to add to the current one on the right hand side of the equation
   ...
   *
   * @param vectorToSub A Vector2 to subtract to the current one on the right hand side of the
   *     equation
   ...
   * Rotates the vector
   *
   * @param angle A double of the angle in radians, by which to rotate the vector. Positive =
   *     counter clockwise
  ...
  /**
   * Calculate the angle of the vector's direction using atan2 Circle begins at (1,0), positive
